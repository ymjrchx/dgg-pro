        ...
        <div class="order-page">
            ...
            <div class="order-page-form">
                ...
                <ul class="clearfix">
                    ...
                    <li v-if="type == 'navigation_trademark'">
                        <label>商标名称：</label>
            ...
            <div class="tabsPanel">
                <ul class="tabs-header clearfix">
                    <li class="list " :class="{'selected': !$route.query.tab}">
                        <a :href="'/center/order?type='+$route.query.type+'&serviceTypeLevel3Code='+serviceTypeLevel3Code+'&contactName='+contactName+'&payWay='+payWay+'&createTimeStart='+createTimeStart+'&createTimeEnd='+createTimeEnd">全部</a>
                    </li>
                    <li class="list " :class="{'selected': $route.query.tab == 'order_status_obligation'}">
                        <a :href="'/center/order?type='+$route.query.type+'&tab=order_status_obligation'+'&serviceTypeLevel3Code='+serviceTypeLevel3Code+'&contactName='+contactName+'&payWay='+payWay+'&createTimeStart='+createTimeStart+'&createTimeEnd='+createTimeEnd">未付款</a>
                    </li>
                    <li class="list " :class="{'selected': $route.query.tab == 'order_status_inprocess'}">
                        <a :href="'/center/order?type='+$route.query.type+'&tab=order_status_inprocess'+'&serviceTypeLevel3Code='+serviceTypeLevel3Code+'&contactName='+contactName+'&payWay='+payWay+'&createTimeStart='+createTimeStart+'&createTimeEnd='+createTimeEnd">服务中</a>
                    </li>
                    <li class="list " :class="{'selected': $route.query.tab == 'order_status_completed'}">
                        <a :href="'/center/order?type='+$route.query.type+'&tab=order_status_completed'+'&serviceTypeLevel3Code='+serviceTypeLevel3Code+'&contactName='+contactName+'&payWay='+payWay+'&createTimeStart='+createTimeStart+'&createTimeEnd='+createTimeEnd">已完成</a>
                    </li>
                    <li class="list " :class="{'selected': $route.query.tab == 'order_status_evaluate'}">
                        <a :href="'/center/order?type='+$route.query.type+'&tab=order_status_evaluate'+'&serviceTypeLevel3Code='+serviceTypeLevel3Code+'&contactName='+contactName+'&payWay='+payWay+'&createTimeStart='+createTimeStart+'&createTimeEnd='+createTimeEnd">已评价</a>
                    </li>
                </ul>
                <!-- start tabs-bodyer -->
...
export default {
    ...
    methods: {
        loadOrder(page) {
            ...
            if (this.code == "navigation_trademark") {
                requireObj = Object.assign({}, requireObj, {
                    type: "order_type1"
                });
            }
            this.$Http("/order/queryUserOrder", requireObj, "get").then(res => {
