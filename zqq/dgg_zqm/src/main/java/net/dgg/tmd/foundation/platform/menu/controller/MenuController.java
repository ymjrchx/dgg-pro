...
public class MenuController extends BaseController{
    ...
    @ResponseBody
    public RestResponse<String> addMenu(MenuMain menuMain,String ancestorIds){
    ...
    @ResponseBody
    public RestResponse<MenuNodeDto> getMenuInfo(@RequestParam String menuId){
    ...
    @ResponseBody
    public RestResponse<List> getNextNode(String menuId){
    ...
    @ResponseBody
    public RestResponse<String> updateMenu(MenuMain menuMain){
        String flag = checkParam(menuMain);
        if(!flag.equals("pass")){
            return this.getFailResponse(flag);
        }
    ...
    @ResponseBody
    public RestResponse<String> deleteMenu(String menuIds){
