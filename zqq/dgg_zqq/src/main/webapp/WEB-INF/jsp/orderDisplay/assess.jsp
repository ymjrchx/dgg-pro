...
<div class="tableDiv">
    ...
    <table class="table" style="width: 100%;">
        ...
        <tr>
            <td>
                ...
                <p class="p-style">商标类型：${tra.type}</p>
    ...
    <div id="assessTable">
        <table class="table" style="width: 100%;">
            <thead>
            <th><p class="p-style2" style="border-bottom: 1px solid black"><span>评估记录</span></p></th>
            <th></th>
            </thead>
            <tbody>

            <c:forEach items="${failAssess}" var="assess">
                <tr style="border-top: 1px solid olive ;border-bottom: 1px solid olive">

                    <td style="width: 400px;">
                        <label style="font-size: 20px">评估内容：</label>
                        <p style="color: orangered;font-size: 15px">&nbsp&nbsp;${assess.assessContent} </p>
                    </td>
                    <td>
                        <c:if test="${assess.photoList!=null }">
                            <c:forEach items="${assess.photoList}" var="photo">
                                <c:if test="${photo!=null && photo!=''}">
                                    <img class="open-img"
                                         style="word-break: keep-all;word-wrap:normal;display: inline-block;"
                                         alt="评估图片" width="150" height="150" src="${host}${photo}">
                                </c:if>
                            </c:forEach>
                        </c:if>
                    </td>
                    <td>
                        <p style="font-size: 15px">${assess.createTime} </p>
                    </td>
