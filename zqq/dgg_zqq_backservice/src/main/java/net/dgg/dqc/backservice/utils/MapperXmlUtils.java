...
public class MapperXmlUtils {
    ...
    private String daoPackage = "dao_mybatis";
    private String DaoSuffix = "Dao";

    public static void main(String[] a) {

        new MapperXmlUtils().createMapper(ImgDealResult.class, "t_img_deal_result");
    }
    ...
    public void createMapper(Class<?> entity, String... tableNameAndAlias) {
        ...
        String mapperName = "mapper\\".concat(this.entity.getSimpleName()).concat(this.DaoSuffix).concat("Mapper.xml");

        System.out.println(daoPath + daoFileName);
        System.out.println(daoPath + mapperName);
        this.createDao(daoPath + daoFileName);
        this.createXml(daoPath + mapperName);
        System.out.println("创建完成！");
    }

    private void createXml(String xmlPath) {
        File daoFile = new File(xmlPath);
        /*if (daoFile.exists()) {
    ...
    private void createDao(String daoFilePath) {
    ...
    private String getDaoPath() {
        ...
        return projectPath + "\\src\\main\\java\\" + this.getDaoPackage().replace(".", "\\");
    }
