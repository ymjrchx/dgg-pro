...
import net.dgg.tmd.foundation.platform.user.dao.OrgClosureDAO;
...
public class OrganizationManager {
    ...
    public boolean loadAndSaveOrgFromServer(long orgId){
        ...
        HashMap responseData = JsonUtil.json2Obj(HttpUtils.sendPost(USERCENTER_ORG_APIURL, USERCENTER_APPTOKEN, "orgId=" + orgId), HashMap.class);
        HashMap orgFromServer = JsonUtil.json2Obj(responseData.get("dataobject").toString(), HashMap.class);
        //将服务器返回数据转为组织机构实体
