package net.dgg.gspt.dqc.services.trademark.impl;

import lombok.Cleanup;
import lombok.SneakyThrows;
import lombok.extern.slf4j.Slf4j;
import net.dgg.gspt.dqc.dao.trademark.TrademarkDao;
import net.dgg.gspt.dqc.services.trademark.TrademarkService;
import net.dgg.gspt.dqc.utils.ThreadHelper;
import net.dgg.gspt.dqc.utils.Toolkit;
import net.dgg.gspt.dqc.utils.es.EsClientUtils;
...
public class TrademarkServiceImpl implements TrademarkService {
    ...
    private void write(List<Map<String, Object>> datas, HttpServletResponse response) {
        ...
        if (datas.isEmpty()) {
            ...
            response.setHeader("content-disposition", "attachment;filename="
                    + URLEncoder.encode("顶企查商标-" + Toolkit.DateUtils.format(System.currentTimeMillis(), "yyyyMMddHHmmss") + ".xls", "UTF-8"));
