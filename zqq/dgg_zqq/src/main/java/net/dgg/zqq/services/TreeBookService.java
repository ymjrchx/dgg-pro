...
import net.dgg.zqq.controller.treebook.CommonConstant;
import net.dgg.zqq.dao.TreeBookDao;
import net.dgg.zqq.framework.Constants;
import net.dgg.zqq.entity.business.treebook.TreeBook;
import net.dgg.zqq.exception.BookException;
...
public class TreeBookService extends AbstractMongoCacheModule<String> {
    ...
    public List<TreeBook> getTreeBookListByCode(String code, Integer status, Integer type, Integer level) {
        ...
        cacheName += (net.dgg.zqq.utils.StringUtils.isEmptyObj(type) ? "" : "_type" + type);
        cacheName += (net.dgg.zqq.utils.StringUtils.isEmptyObj(status) ? "" : "_status" + status);
        cacheName += (net.dgg.zqq.utils.StringUtils.isEmptyObj(level) ? "" : "_level" + level);
