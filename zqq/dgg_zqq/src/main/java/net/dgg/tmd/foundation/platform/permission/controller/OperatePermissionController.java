package net.dgg.tmd.foundation.platform.permission.controller;
...
public class OperatePermissionController extends BaseController{
    @Autowired
    ...
    public String index(String operatePermissionName,String operatePermissionId, HttpServletRequest request){
        if(ValidateUtil.strNotEmpty(operatePermissionName, null,"操作权限名称不允许为空！")){
            request.setAttribute("operatePermissionName",request.getParameter("operatePermissionName").toString());
        }
        if(ValidateUtil.strNotEmpty(operatePermissionId, null,"操作权限ID不允许为空！")){
    ...
    @ResponseBody
    public RestResponse add(OperatePermissionEntity operatePermissionEntity){
        try {
    ...
    @ResponseBody
    public RestResponse update(OperatePermissionEntity operatePermissionEntity){
    ...
    @ResponseBody
    public RestResponse delete(String operatePermissionId){
    ...
    @ResponseBody
    public RestResponse search(String operatePermissionName){
