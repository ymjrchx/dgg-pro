...
<div class="body-main">
    ...
    <div class="titleSearch">
        ...
        <div class="layui-inline">
            <label>服务项编号</label>
            <div class="layui-input-inline">
                <input name="number" type="text" class="input-style" maxlength="50"
                       placeholder="请输入编号">
            </div>
        </div>
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline select2-inline">
                <select name="service_attr" class="select-style" tree-book-select="service_attr">
        ...
        <div class="layui-inline">
            <label>服务价格：</label>
            <div class="layui-input-inline">
                <input name="servicePrice" type="number" min="0" class="input-style" maxlength="50"
                       placeholder="请输入价格">
            </div>
        </div>
        <div class="layui-inline">
    ...
    <div class="table-body">
        ...
        <table id="mytable" class="cell-border crm-table columnsHidden dataTable">
            ...
            <tr>
                ...
                <th width="50px">序号</th>
                <th width="120px">服务项编号</th>
                <th width="120px">服务项名称</th>
                <th>服务费（元）</th>
                <th>官费(元)</th>
                <th>所属一级类别</th>
                <th>所属二级类别</th>
...
<script type="text/javascript">
    ...
    function openAddPage() {
        DGG.Layer.open("${pageContext.request.contextPath}/serviceItem/addPage.html", {
            title: '添加服务项',
            area: ['90%', '80%'],
            btn: ''
        });
    ...
    function openUpdatePage(id) {
        DGG.Layer.open("${pageContext.request.contextPath}/serviceItem/updatePage.html?id=" + id, {
            title: '修改服务项',
            area: ['90%', '80%'],
            btn: null
        });
    ...
    function deleteById(id, name) {
        DGG.Layer.confirm("删除服务项【" + name + "】 ,将也将删除服务项与此服务属性的关系记录，确认是否删除？", function () {
            DGG.Layer.loading.start();
            $.ajax({
                url: "${pageContext.request.contextPath}/serviceItem/delete.do", //处理的页面
                data: {
                    id: id
                },
                type: "POST",  //提交方式
    ...
    $(document).ready(function () {
        ...
        table = $('#mytable').dataTableExtend({
            "ajax": {"url": "${pageContext.request.contextPath}/serviceItem/queryPage.do", type: "post"},
            ...
            "aoColumns": [
...

                {
                    ...
                    "orderable": false,
                    "data": "typeLevel1CodeName",
                    "render": function (data, type, full, meta) {
                        return (data ? data : '');
                    }
                }, {
                    "orderable": false,
                    "data": "typeLevel2CodeName",
                    "render": function (data, type, full, meta) {
                        return (data ? data : '');
                    }
                }, {
                    "orderable": false,
                    "data": "typeLevel3CodeName",
                    "render": function (data, type, full, meta) {
                        return (data ? data : '');
                    }
                }, {
                ...
                },
                {
                    ...
                    "render": function (data, type, r, meta) {
                        ...
                        result += '<a href=\'javascript:void(0)\' ti  onclick="deleteById(\'' + r.id + '\',\'' + r.name + '\')" /><span class="layui-table-link" style="white-space: nowrap;">删除</span></a>&nbsp;';
