package net.dgg.yk.platform.backend.business.a1.dependencies.util;

import net.dgg.yk.common.Toolkit;
import net.dgg.yk.platform.backend.business.a1.dependencies.entity.parse.NewsModel;
import net.dgg.yk.platform.backend.business.a1.dependencies.entity.parse.QccCompany;
import net.dgg.yk.platform.backend.business.a1.dependencies.entity.parse.SbDetails;
import net.dgg.yk.platform.backend.business.a1.dependencies.entity.parse.resume.ResumeModel;
import net.dgg.yk.platform.backend.business.a1.dependencies.entity.parse.zcgl.ZcglModel;
import net.dgg.yk.platform.backend.mapping.CNYWan;
import net.dgg.yk.platform.backend.mapping.DateConvert;
...
public class BaseUtil {
    ...
    public static double dealMoney(Object o) { //返回单位是万元
        Function<String, Double> dealFunction = new CNYWan();
        if (o != null) {
            return dealFunction.apply(o.toString()).doubleValue();
        } else {
            return 0D;
        }
        /**
    ...
    public static String dealDate(String date) {
        Function<String, Date> function = new DateConvert();
        Date dateParsed = function.apply(date);
        return Toolkit.DateUtils.format(dateParsed.getTime(), "yyyy-MM-dd");
        /**
