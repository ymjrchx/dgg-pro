...
public class EsUtils extends BaseUtil {
    ...
    public static void createMapping(String index, String type, Class cls) {
        try {
            String template = "{\n"
                    + "\t\"" + type + "\":{\n"
            ...
            PutMappingRequest mapping = Requests.putMappingRequest(index).type(type).source(createIKMapping());
