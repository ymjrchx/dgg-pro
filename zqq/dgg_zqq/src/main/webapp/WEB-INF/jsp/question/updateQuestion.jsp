                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline" style="width: 800px;">
                                ...
                                <textarea id="question" name="question" type="text" class="input-style" maxlength="100"
                                          ...
                                          placeholder="请输入问题概述(低于100字节)">${question.question}</textarea>
                            </div>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="4">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline" style="width: 800px;">
                                <textarea id="questionAppend" name="questionAppend" type="text" class="input-style"
                                          maxlength="300"
                                          style="height: 80px;width:inherit;min-width:800px;resize: none;"
                                          placeholder="请输入问题补充(低于300字节)">${question.questionAppend}</textarea>
                            </div>
                        </div>
                    </td>
                </tr>
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input id="keyWord" name="keyWord" type="text" class="input-style" maxlength="50"
                                       min="0"
                                       placeholder="请输入问题关键字" value="${question.keyWord}">
                            </div>
                        </div>
                    </td>
                </tr>
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline select2-inline">
                                <select id="createWay" name="createWay" class="select-style">
                                    ...
                                    <option value="1" <c:if test="${question.createWay == '1'}">selected</c:if>>内部创建</option>
                                    <option value="2" <c:if test="${question.createWay == '2'}">selected</c:if>>外部创建</option>
                                </select>
                            </div>
                        </div>
                    </td>
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline select2-inline">
                                <select id="recommend" name="recommend" class="select-style">
                                    <option value="">请选择</option>
                                    <option value="0" <c:if test="${question.recommend == 0}">selected</c:if>>是</option>
                                    <option value="1" <c:if test="${question.recommend == 1}">selected</c:if>>否</option>
                                </select>
                            </div>
                        </div>
                    </td>
                ...
                <tr>
                    <td colspan="4">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <select id="typeLevel1Code" name="typeLevel1Code" class="select-style"
                                        three-level-select="navigation_data"
                                        data-value="${question.typeLevel1Code}">
                                    <option value="">请选择</option>
                                </select>
                                <select id="typeLevel2Code" name="typeLevel2Code" class="select-style"
                                        data-value="${question.typeLevel2Code}">
                                    <option value="">请选择</option>
                                </select>
                                <select id="typeLevel3Code" name="typeLevel3Code" class="select-style"
                                        data-value="${question.typeLevel3Code}">
                                    <option value="">请选择</option>
                                </select>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    function addPage() {
        ...
        if (question == '') {
            DGG.Layer.message("问题概述不能为空aaa", {icon: '2'}, function () {
            });
            return;
        }
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/question/update.do", //处理的页面
            data: {
