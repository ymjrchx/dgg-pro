package net.dgg.bigdata.manager.user.controller;
...
import net.dgg.bigdata.manager.user.service.OrganizationManager;
...
public class UserController extends DggBaseController {
    @Autowired
    ...
    @ResponseBody
    public DggRestResponse<List> getNextNode(@RequestParam Long orgId) {
