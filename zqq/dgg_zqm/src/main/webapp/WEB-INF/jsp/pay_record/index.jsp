    ...
    <div class="titleSearch">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input name="orderId" type="text" class="input-style" maxlength="50"
                       placeholder="请输入订单编号">
            </div>
        </div>
        <div class="layui-inline">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <select id="serviceTypeLevel1Code" name="serviceTypeLevel1Code" class="select-style"
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline select2-inline">
                <select name="payWay" class="select-style">
                    <option value="">请选择</option>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        table = $('#mytable').dataTableExtend({
            "ajax": {"url": "${pageContext.request.contextPath}/payRecord/queryPage.do", type: "post"},
            ...
            "aoColumns": [
...

                {
                    ...
                    "render": function (data, type, r, meta) {
                        var result = "";
                        /* result += '<a href=\'javascript:void(0)\' ti  onclick="updateStatus(\'' + r.id + '\')" /><span class="layui-table-link">修改状态</span></a>&nbsp;';*/
                        return result;
