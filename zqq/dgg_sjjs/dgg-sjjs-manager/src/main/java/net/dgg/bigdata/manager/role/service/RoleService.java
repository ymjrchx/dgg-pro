package net.dgg.bigdata.manager.role.service;

import net.dgg.bigdata.manager.menu.dao.MenuOperatePermissionDao;
import net.dgg.bigdata.manager.role.dao.RoleDao;
import net.dgg.bigdata.manager.role.dao.RoleMenuDao;
import net.dgg.bigdata.manager.role.dao.RoleOperatePermissionDao;
import net.dgg.bigdata.manager.role.entity.*;
    ...
    private List<RoleMenuPermission> roleMenuDataPackag(Role role, Set<Long> nodeIds) {
        ...
        if (nodeIds.size() > 0) {
            for (Long nodeId : nodeIds) {
                ...
                roleMenuPermission.setId(DggKeyWorker.nextId());
        ...
        if (operatePermissionIds.size() > 0) {
            ...
            while (it.hasNext()) {
                ...
                if (roleOperatePermissionDao.exitsByRoleOperate(role.getRoleId(),operatePermissionId) == 0) {
                    ...
                    roleOperatePermission.setId(DggKeyWorker.nextId());
