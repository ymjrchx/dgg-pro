...
import net.dgg.zqq.config.ImgConfig;
import net.dgg.zqq.framework.imgidentify.Base64Util;
import net.dgg.zqq.framework.imgidentify.FileUtil;
import net.dgg.zqq.framework.imgidentify.HttpUtil;
import net.dgg.zqq.framework.imgidentify.ImgDealUtils;
import net.dgg.zqq.framework.interceptor.ConstMethod;
import net.dgg.zqq.services.search.ImgService;
...
import static net.dgg.zqq.framework.imgidentify.ImgDealUtils.getTmpPath;
