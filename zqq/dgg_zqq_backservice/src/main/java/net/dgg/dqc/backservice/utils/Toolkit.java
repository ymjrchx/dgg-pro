                ...
                try {
                    ...
                    switch (method.trim().toLowerCase()) {
                        case "post":
                            ...
                            httpsConn.connect();
                            @Cleanup OutputStream os = httpsConn.getOutputStream();
                            os.write(data);
                            os.flush();
                            break;
                        case "get":
                    ...
                    @Cleanup InputStream is = httpsConn.getInputStream();
                    int readc = 0;
                ...
                try {
                    ...
                    switch (method.trim().toLowerCase()) {
                        case "post":
                            ...
                            httpConn.connect();
                            @Cleanup OutputStream os = httpConn.getOutputStream();
                            os.write(data);
                            os.flush();
                            break;
                        case "get":
                    ...
                    @Cleanup InputStream is = httpConn.getInputStream();
                    int readc = 0;
                    ByteArrayOutputStream bo = new ByteArrayOutputStream();
                    byte[] buff = new byte[122];
                    while ((readc = is.read(buff)) != -1) {
