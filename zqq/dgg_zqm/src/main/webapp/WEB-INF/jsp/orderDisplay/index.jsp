...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        table = $('#mytable').dataTableExtend({
            "ajax": {"url": "${pageContext.request.contextPath}/orderDisplay/queryPage.do", type: "post"},
            ...
            "aoColumns": [
                ...
                },
                {
                    ...
                    "render": function (data, type, r, meta) {
                        var result = "";
                        if ('已付款' == r.status || '办理中' == r.status) {
                            result += '<a id="a1"  href=\'javascript:void(0)\' ti  onclick="updateStatus(\'' + r.id + '\',\'' + r.status + '\')" /><span class="layui-table-link">修改状态</span></a>&nbsp;';
                        }
                        return result;
