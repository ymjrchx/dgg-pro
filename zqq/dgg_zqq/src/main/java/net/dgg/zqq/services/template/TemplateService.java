package net.dgg.zqq.services.template;
...
import net.dgg.zqq.constant.TemplateTypeConstant;
import net.dgg.zqq.constant.UserIdKeyConstant;
import net.dgg.zqq.dao.template.TemplateDao;
import net.dgg.zqq.dao.template.TemplateExtDao;
...
public class TemplateService {
    ...
    public List<Map<String, Object>> findByTemplateTypes(String templateTypes) {
