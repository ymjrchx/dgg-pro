...
public class Fygg {
    ...
    private String cPage; //刊登版面
    private String aAppellor; //上诉方
    private String cJudge; //公告人


    private List<NameKeyNoCollection> nameKeyNoColl; //当事人信息

    public String getaAppellor() {
        return aAppellor;
    }

    public void setaAppellor(String aAppellor) {
        this.aAppellor = aAppellor;
    }
