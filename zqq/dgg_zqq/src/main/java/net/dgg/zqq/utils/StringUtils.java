...
public class StringUtils {
    ...
    public static boolean isEmptyObj(Object obj) {
        return (null == obj || "".equals(obj.toString()) || "".equals(obj.toString().trim()) || "null".equalsIgnoreCase(obj.toString()));
    }
     ...
     * @return
     */
    public static boolean isOnlySimpleChinese(String str) {
        if (isEmpty(str)) {
            return false;
        }
        String reg = "[\\u4E00-\\u9FA5]+";
    ...
    public static void main(String[] s) {
        String str = "全是汉字";
        String str1 = "不仅仅是汉字！dasda  dssadd";
        String str2 = "呭萨达萨达Fsd水電費阿斯達";
        System.out.println("str" + isOnlySimpleChinese(str));
        System.out.println("str1" + isOnlySimpleChinese(str1));
        System.out.println("str2" + isOnlySimpleChinese(str2));
    }
