...
<script type="text/javascript">
    ...
    function getUserRecord(userId, username) {
        DGG.Layer.open("${pageContext.request.contextPath}/operation/userRecord.html?userId=" + userId + "&username=" + username, {
            title: '操作记录',
            area: ['90%', '80%'],
            btn: ''
        });
            ...
            "aoColumns": [
                ...
                },
                {
                    ...
                    "render": function (data, type, r, meta) {
                        ...
                        result += '<a href=\'javascript:void(0)\' ti  onclick="getUserRecord(\'' + r.userId + '\',\'' + r.username + '\')" /><span class="layui-table-link">操作记录</span></a>&nbsp;';
