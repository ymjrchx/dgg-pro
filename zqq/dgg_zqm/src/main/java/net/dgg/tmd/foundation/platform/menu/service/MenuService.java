package net.dgg.tmd.foundation.platform.menu.service;

import net.dgg.tmd.foundation.platform.common.filter.MenuUrlsCache;
import net.dgg.tmd.foundation.platform.menu.dao.MenuDao;
...
public class MenuService {
    ...
    public String addMenu(MenuMain menuMain, List<Long> ancestorIds) {
        ...
        for (int i = 0; i < ancestorIds.size(); i++) {
            ...
            menuClosure.setId(KeyWorker.nextId());
        ...
        if (menu != null && menu.getMenuId() == menuId) {
            ...
            if (StringUtils.isEmpty(operateIds)) {
                ...
                for (OperatePermissionEntity operatePermissionEntity : operatePermissionEntities) {
                    ...
                    menuOperatePermission.setId(KeyWorker.nextId());
