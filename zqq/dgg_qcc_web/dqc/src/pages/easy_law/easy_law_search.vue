    ...
    <div class="search_body">
        ...
        <div class="logoSearch">
            <div class="container w" style="line-height:1.8">
                <div class="clogo">裁判文书查询</div>
                <div class="searchStyle">
                    <ul class="style_list">
                        <li v-for="(item,index) in styleArr" :class="{'active': isCheck === index }" :key="index" @click="updateCheck(index)">{{item}}</li>
                    </ul>
                    <div class="searchBox input-group">
                        <el-autocomplete popper-class="input-autocomplete" v-model="tabval" :fetch-suggestions="querySearchAsync" :placeholder="placeHolderArr[isCheck]" @keyup.enter.native="submit">
...
export default {
    ...
    methods: {
        ...
        initHistory() {
            let arr;
            arr = Common.getHistory("easy_law");
