  ...
  <div class="login-panel">
    ...
    <div class="login-panel-body login">
      <div class="form-group">
        <el-input placeholder="请输入手机号码" v-model="nameVal" clearable maxlength="11">
      ...
      <div class="form-group m-t-md">
        <el-input placeholder="请输入密码" v-model="passVal2" clearable type="password" @keyup.enter.native="submit">
      ...
      <div class="checkbox m-t-md">
        ...
        <router-link to='/Agreement' class="text-primary ">《顶企查用户协议》</router-link>
      </div>
    ...
    methods: {
        getCode() {
            ...
            this.$axios({
                ...
                data:{ phoneNo: this.nameVal, type: "regist" },
                success:res => {
                    let json = res.data;
                    //console.log("短信",json)
                    if (json.code == 0) {
