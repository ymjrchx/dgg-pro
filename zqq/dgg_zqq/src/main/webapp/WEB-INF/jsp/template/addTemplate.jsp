     ...
     <form id="addTemplate">
            <table class="table" id="questionDataTable" style="width: 100%;">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline select2-inline">
                                <select style="width: 500px" id="templateType" name="templateType" class="select-style"
                                        tree-book-select="template_type">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input style="width: 500px" id="templateName" name="templateName" type="text"
                                       class="input-style" maxlength="50" min="0"
                                       placeholder="请输入模板名称(不超过50个字节)">
                            </div>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="8">
                        <div class="layui-inline">
                            <label class="required"> 模板内容：</label>
                            <div class="layui-input-inline select2-inline">
                                <input style="width: 500px" id="file" type="file" name="file" class="select-style"
...
<script type="text/javascript">
    ...
    function addPage() {
        ...
        var file = $("#file").val();
        if (file == null || file == '') {
            DGG.Layer.message("文件不能为空", {icon: '2'}, function () {
            });
            return;
        }


        var form = new FormData(document.getElementById("addTemplate"));
