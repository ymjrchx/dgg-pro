package net.dgg.gspt.dqc.controller.customerMsg;
...
import net.dgg.gspt.dqc.services.customerMsg.CustomerMsgService;
...
public class CustomerMsgController extends BaseController {
    ...
    public Object save(
            @ApiParam(name = "customerMsg", value = "客留信息，type ： 普通:customer_msg_type_01,加盟：customer_msg_type_02") @RequestBody CustomerMsg customerMsg) {
        try {
