            ...
            <form id="form">
                <table class="add-table">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="ext1" value="" placeholder="有客系统 分类单位 使用" class="input-style"></td>
                        <th><span class="form-label">扩展字段2：</span></th>
                        <td><input type="text" name="ext2" value="" placeholder="有客系统设置为‘hot’表示热门" class="input-style"></td>
                    ...
                    <tr>
                        ...
                        <th><span class="form-label">前端显示状态：</span></th>
                        <td>
                            <select class="select-style" name="ext5" data-placeholder="前端显示状态">
                    ...
                    <tr>
                        ...
                        <td colspan="3"><textarea type="text" id="description" name="description" class="textarea-style"
                                                  style="height: 60px;" placeholder="有客系统 提示信息 使用"></textarea></td>
                    </tr>
                    <tr>
                        <th></th>
                        <td>
