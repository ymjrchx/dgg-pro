...
import net.dgg.dqc.backservice.framework.ai.HttpUtils;
...
public class APPCodeDemo {
    ...
    public static void main(String[] args) {
        String imgFile = "D:\\DGG\\files\\成都名片466张\\成都 (14690).png";
        System.out.println(parsingImg(imgFile));
    }

    public static String parsingImg(String imgFile){

        String host = "http://dm-57.data.aliyun.com";
        String path = "/rest/160601/ocr/ocr_business_card.json";
        String appcode = "83ccf9229c644253940b8e4b492c8ebf";
//        String imgFile = "图片路径";
//        final String imgFile = "D:\\DGG\\files\\成都名片466张\\成都 (18980).png";
