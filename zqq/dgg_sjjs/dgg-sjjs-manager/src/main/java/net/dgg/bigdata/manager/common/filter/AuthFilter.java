...
import net.dgg.bigdata.manager.common.util.YmlUtils;
...
public class AuthFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		// 获取会话管理器
		SessionManager sessionManager = DggSpringContext.getBean("sessionManager", SessionManager.class);
		// 获取角色服务
		RoleService roleService = DggSpringContext.getBean("roleService", RoleService.class);
		// 获取菜单urls
		MenuUrlsCache menuUrlsCache = DggSpringContext.getBean(MenuUrlsCache.class);
		// 获取当前请求uri
