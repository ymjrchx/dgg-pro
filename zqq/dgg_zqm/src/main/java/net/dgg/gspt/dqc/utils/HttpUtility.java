...
public class HttpUtility {
     ...
     * @throws ClientProtocolException
     */
    public static String getRest(String url, Map<String, Object> params, String charset
    ) throws ClientProtocolException, IOException {
        String resultStr = "";
        // 将Map类型的参数转成字符串类型
        StringBuffer stringBuffer = new StringBuffer();
...
//            System.out.println("POST方式结果：" + resultStr);
     ...
     * @throws ClientProtocolException
     */
    public static String postRest(String url, Map<String, Object> params, String charset) throws ClientProtocolException, IOException {
        String resultStr = "";
        HttpClient client = new DefaultHttpClient();
