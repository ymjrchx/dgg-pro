...
public class SqlUtils {
    ...
    public String createUpdateSql(Class<?> entity, String tableName, String idName) {
        ...
        sb.append(sj).append(" WHERE ").append(this.transUpperToLineAndLower(idName)).append(blank).append(eq).append(blank).append(sharpS).append(idName).append(sharpE);
    ...
    public String createFindByIdSql(Class<?> entity, String tableName, String alias, String idName) {
        ...
        sb.append(sj).append("WHERE").append(blank).append(alias).append(dot).append(g).append(this.transUpperToLineAndLower(idName)).append(g).append(eq).append(sharpS).append(idName).append(sharpE);
        return sb.substring(0);
    }
    ...
    public String createDeleteByIdSql(Class<?> entity, String tableName, String idName) {
        ...
        sb.append(sj).append("DELETE FROM ").append(tableName).append(blank).append(where)
                .append(blank).append(g).append(this.transUpperToLineAndLower(idName)).append(g).append(eq).append(sharpS).append(idName).append(sharpE);
        return sb.substring(0);
    }
