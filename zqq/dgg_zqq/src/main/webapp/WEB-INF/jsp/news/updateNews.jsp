...
<div class="body-main">
    ...
    <div class="titleSearch" style="border-bottom-width: 0px;">
        <table class="table" id="urlTable" style="width: 100%;">
            ...
            <tr>
                ...
                <td>
                    <div class="layui-inline">
                        <label>创建时间：</label>
                        <div class="layui-input-inline">
                            <input type="text" name="createTime" placeholder="开始时间" class="Wdate input-style"
                                   id="d4311"
                                   value="<fmt:formatDate value="${news.createTime }" pattern="yyyy-MM-dd HH:mm:ss"/>"
                                   onFocus="WdatePicker({onpicked:function(){}, dateFmt:'yyyy-MM-dd HH:mm:ss'})">
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <div class="layui-inline"><label class="required">资讯图片：</label></div>
                </td>
                <td colspan="2">
                    <div class="layui-inline"><label class="required">文本内容：</label></div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
