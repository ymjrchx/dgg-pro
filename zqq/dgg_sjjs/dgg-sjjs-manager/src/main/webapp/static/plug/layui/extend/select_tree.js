		...
		start:function() {
			...
			if(isCheck) {
				treeHtm+='<div class="tree-btn">'+
						 '<a href="javascript:void(0)" class="layui-btn layui-btn-xs layui-btn-normal" id="get_'+treeId+'">确定</a>'+
						 '<a href="javascript:void(0)" class="layui-btn layui-btn-xs layui-btn-primary" id="reset_'+treeId+'">关闭</a>'+
						 '</div>'
			}
			treeHtm+='</div>';
			if(form) {
