                                    ...
                                    <div class="have-answer">
                                        ...
                                        <div class="bbs-post-left" v-if="showInfo">
                                            <div class="site">
                                                ...
                                                <i class="songti"> &gt; </i>
                                                <a :href="'/question/'+ showInfo.question.typeLevel1Code+'.html'" rel="nofollow">{{type}}
                                                    <i class="songti"> &gt;</i>
                                                </a>
                                                <i class="songti"> </i>
...
export default {
    async asyncData({ params, redirect, error, env, store, route }) {
        ...
        return Promise.all([
            ...
            if (!res[0].data.data) {
                ...
                let typeArr = {
                    navigation_trademark: "商标问答",
                    navigation_patent: "专利问答",
                    navigation_copyright: "版权问答"
                };
                let showInfo = res[0].data.data;
                return {
                    showInfo,
                    ...
                    content:
                        showInfo.answer.answer.length < 120
                            ? showInfo.answer.answer
                            : showInfo.answer.answer.substring(0, 120)
                };
            }
        });
    },
    head() {
        return {
            title: `${this.showInfo ? this.showInfo.question.question : ""}-${
                this.type
            }-知千秋官网`,
            meta: [
                {
